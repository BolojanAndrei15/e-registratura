...
const registers = [
  {
    id: 1,
    name: "Registru Intrări 2025",
    type: "Registru Intrări-Ieșiri",
    date: "01.01.2025",
    count: 156,
  },
  {
    id: 2,
    name: "Registru Facturi 2025",
    type: "Registru Facturi",
    date: "01.01.2025",
    count: 89,
  },
];

export default function SectionRegistre() {
              ...
              {paginatedRegisters.map((reg) => (
                <TableRow key={reg.id} className="bg-card">
                  ...
                  <TableCell className="text-muted-foreground text-base border-b border-border last:border-b-0 truncate">
                    <span className="truncate">{reg.type}</span>
                  </TableCell>
                  ...
                  <TableCell className="text-center border-b border-border last:border-b-0 truncate">
                    <Badge className="bg-green-500 dark:bg-green-800 dark:text-gray-200 border-none px-3 py-1 text-sm font-medium">
                      {reg.count} înregistrări
                    </Badge>
                  </TableCell>
                  <TableCell className="flex items-center justify-center gap-2 text-primary text-lg border-b border-border last:border-b-0">
                    ...
                    <Button variant="ghost" size="icon" title="Editează" className="text-primary hover:bg-primary/10">
                      <Pencil className="w-5 h-5" />
                    </Button>
                    <Button variant="ghost" size="icon" title="Șterge" className="text-destructive hover:bg-destructive/10">
